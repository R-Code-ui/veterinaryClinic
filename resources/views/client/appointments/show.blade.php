        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <!-- QR Code Section (Client) -->
                    <div class="mt-8 border-t pt-6">
                        <h3 class="text-lg font-bold mb-4">QR Code for {{ $pet->name }}</h3>
                        <div class="flex items-center space-x-6">
                            <div class="bg-white p-4 rounded-lg shadow">
                                {!! QrCode::size(150)->generate(route('client.pets.show', $pet->id)) !!}
                            </div>
                            <div>
                                <p class="text-sm text-gray-600 mb-2">Scan to open this pet's profile.</p>
                                <a href="{{ route('client.pets.qrcode-png', $pet) }}"
